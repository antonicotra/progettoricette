    ...
    await transporter.sendMail({
        ...
        html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <p>
                        <a href="http://localhost:3000/auth/reset-password?resetToken=${resetPasswordToken}" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 5px;">
                            Reset Password
                        </a>
                    </p>
                    <p>Se non riesci a cliccare sul pulsante, copia e incolla questo link nel tuo browser:</p>
                    <p>http://localhost:3000/auth/reset-password?resetToken=${resetPasswordToken}</p>
